{{--
  _panel_tarabal_murti.blade.php — तारबल एवं मूर्ति निर्णय
...
<style>
/* ═══════════════════════════════════════════════════════════
   TARABAL + MURTI PANEL — वैदिक पाराशर शैली  v2 (larger fonts)
   ═══════════════════════════════════════════════════════════ */
#tarabalPanel {
  --bg0    : #fdf6ec;
  --bg1    : #f9edd8;
...
.tm-hero::after {
  content:'ॐ';position:absolute;right:44px;top:50%;transform:translateY(-50%);
...
<div id="tarabalPanel" style="display:none">
  ...
  <div class="tm-hero">
    <div class="tm-hero-inner">
      <div class="tm-eyebrow">बृहत् पाराशर होरा शास्त्र · मुहूर्त चिन्तामणि</div>
      <div class="tm-title-row">
        <div class="tm-title-hi">तारबल एवं मूर्ति निर्णय</div>
      </div>
      <div class="tm-title-sub">Tarabala &amp; Murti Nirnaya — Vedic Auspiciousness Analysis</div>
      <div class="tm-hero-tags">
        <span class="tm-htag">नक्षत्र बल</span>
        <span class="tm-htag">जन्म तारा</span>
        <span class="tm-htag">सम्पत् तारा</span>
        <span class="tm-htag">स्वर्ण मूर्ति</span>
        <span class="tm-htag">लाहिरी अयनांश</span>
      </div>
    </div>
  </div>
  ...
  <div class="tm-input-bar">
    <span class="tm-label">तिथि :</span>
    <input type="date" id="tmDate" class="tm-date-inp" value="{{ date('Y-m-d') }}"/>
    <span class="tm-label">जन्म नक्षत्र :</span>
    <select id="tmBirthNak" class="tm-select">
      <option value="-1">— अज्ञात / सामान्य —</option>
      <option value="0">अश्विनी</option><option value="1">भरणी</option>
      <option value="2">कृत्तिका</option><option value="3">रोहिणी</option>
      <option value="4">मृगशिरा</option><option value="5">आर्द्रा</option>
      <option value="6">पुनर्वसु</option><option value="7">पुष्य</option>
      <option value="8">आश्लेषा</option><option value="9">मघा</option>
      <option value="10">पूर्वाफाल्गुनी</option><option value="11">उत्तराफाल्गुनी</option>
      <option value="12">हस्त</option><option value="13">चित्रा</option>
      <option value="14">स्वाति</option><option value="15">विशाखा</option>
      <option value="16">अनुराधा</option><option value="17">ज्येष्ठा</option>
      <option value="18">मूल</option><option value="19">पूर्वाषाढ़ा</option>
      <option value="20">उत्तराषाढ़ा</option><option value="21">श्रवण</option>
      <option value="22">धनिष्ठा</option><option value="23">शतभिषा</option>
      <option value="24">पूर्वाभाद्रपदा</option><option value="25">उत्तराभाद्रपदा</option>
      <option value="26">रेवती</option>
    </select>
    <select id="tmBirthRashi" class="tm-select" style="min-width:130px">
      <option value="-1">— जन्म राशि —</option>
      <option value="0">मेष</option><option value="1">वृषभ</option>
      <option value="2">मिथुन</option><option value="3">कर्क</option>
      <option value="4">सिंह</option><option value="5">कन्या</option>
      <option value="6">तुला</option><option value="7">वृश्चिक</option>
      <option value="8">धनु</option><option value="9">मकर</option>
      <option value="10">कुम्भ</option><option value="11">मीन</option>
    </select>
  ...
  <div id="tmContent">
    <div class="tm-empty">
      ...
      तिथि और जन्म नक्षत्र चुनकर <strong>"गणना करें"</strong> दबाएं।<br>
      <span style="font-size:1rem;opacity:.7">बिना जन्म नक्षत्र के भी सामान्य मूर्ति निर्णय होगा।</span>
    </div>
  </div>
...
async function tmCalculate() {
  ...
  cont.innerHTML = `<div class="tm-loading">
    ...
    <div class="tm-load-text">BPHS गणना हो रही है…<br>
  ...
  try {
    ...
    cont.innerHTML = `<div class="tm-empty">⚠ त्रुटि: ${e.message}</div>`;
...
function _tmRenderTarabal(d) {
  ...
  const mtypeLabels = ['अति शुभ (लघु/क्षिप्र)','शुभ (मृदु)','मध्यम (चर)','अशुभ (उग्र)','अति अशुभ (तीव्र/तीक्ष्ण)'];

  let html = `
  <div class="tm-info-strip">
    <div>
      <div class="tm-strip-title">${d.varaHi} · चन्द्र: ${d.moonNakHi} (${d.moonNakEn ?? ''}) · ${d.tithiHi ?? ''}</div>
      <div class="tm-strip-sub">सूर्योदय ${d.sunrise} · अस्त ${d.sunset} · राशि: ${d.moonRashiHi}</div>
    </div>
  ...
  html += `<div class="tm-section">
    <div class="tm-section-title">आज का पञ्चाङ्ग — नक्षत्र विवरण</div>
    <div class="tm-panch-row">
      <div class="tm-panch-chip">
        <div class="tm-chip-label">चन्द्र नक्षत्र</div>
        <div class="tm-chip-val">${d.moonNakHi}</div>
        <div class="tm-chip-sub">चरण ${d.moonPada}</div>
      </div>
      <div class="tm-panch-chip">
        <div class="tm-chip-label">नक्षत्र स्वामी</div>
        <div class="tm-chip-val">${d.moonLordHi}</div>
      </div>
      <div class="tm-panch-chip">
        <div class="tm-chip-label">गण</div>
        <div class="tm-chip-val">${d.moonGana}</div>
      </div>
      <div class="tm-panch-chip">
        <div class="tm-chip-label">नाड़ी</div>
        <div class="tm-chip-val">${d.moonNadi}</div>
      </div>
      <div class="tm-panch-chip">
        <div class="tm-chip-label">तत्त्व</div>
        <div class="tm-chip-val" style="color:${d.moonTatvaColor ?? '#000'}">${d.moonTatva}</div>
      </div>
      <div class="tm-panch-chip">
        <div class="tm-chip-label">सूर्य नक्षत्र</div>
        <div class="tm-chip-val">${d.sunNakHi}</div>
        <div class="tm-chip-sub">राशि: ${d.sunRashiHi}</div>
      </div>
    </div>
  </div>`;
  ...
  if (tb) {
    ...
    <div class="tm-section">
      <div class="tm-section-title">तारबल — व्यक्तिगत परिणाम</div>
      <div class="tm-tara-result" style="background:${bg};border-color:${c};color:${c}">
        <div class="tm-tara-hero-row">
          ...
          <div class="tm-tara-main">
            <div class="tm-tara-name-hi" style="color:${c}">${tb.name} तारा</div>
            <div class="tm-tara-num">तारा ${tb.taraNum}/9 · ${tb.en}</div>
        ...
        <div class="tm-tara-body" style="border-color:${c}">
          <strong>फल:</strong> ${tb.phala}
        </div>
        <div class="tm-tara-dist">
          जन्म नक्षत्र: <strong>${tb.birthNakHi}</strong> (${tb.birthNak}) →
          चन्द्र नक्षत्र: <strong>${tb.moonNakHi}</strong> (${tb.moonNak}) →
          दूरी: ${tb.dist} नक्षत्र → तारा ${tb.taraNum}
          · प्रभाव: <strong style="color:${c}">${tb.bonus > 0 ? '+' : ''}${tb.bonus}</strong>
        </div>
        <div class="tm-bphs-box" style="margin-top:14px">
          <div class="tm-bphs-title">॥ बृहत् पाराशर होरा शास्त्र ॥</div>
          ${tb.bphs}
        </div>
      </div>
    </div>`;
    ...
    html += `
    <div class="tm-section">
      <div class="tm-section-title">तारबल — परिणाम</div>
      <div class="tm-empty" style="margin:0;padding:28px">
        <div style="font-size:1.6rem;margin-bottom:10px">ℹ</div>
        जन्म नक्षत्र चुनें तो व्यक्तिगत तारबल परिणाम मिलेगा।<br>
        <span style="font-size:1rem;opacity:.7">नीचे सभी 27 नक्षत्रों की तारा सारिणी देखें।</span>
      </div>
    </div>`;
  }
  ...
  html += `
  <div class="tm-section">
    <div class="tm-section-title">नव तारा विवरण — BPHS Ch.26</div>
  ...
  html += `
  <div class="tm-section">
    <div class="tm-section-title">आज की चन्द्र स्थिति से सभी 27 नक्षत्रों की तारा</div>
    <p style="font-family:'Tiro Devanagari Sanskrit',serif;font-size:1rem;color:var(--ink3);margin:0 0 16px">
      ${d.moonNakHi} से क्रमशः गिनने पर 27 नक्षत्र तीन चक्रों में 9-9 तारा देते हैं:
    </p>
  ...
  (d.taraTable ?? []).forEach((item) => {
    ...
    html += `
      <div style="display:flex;align-items:center;gap:10px;padding:10px 14px;border-radius:8px;
        ...
        ${isBirth ? '<span style="font-size:.7rem;position:absolute;top:4px;right:6px;color:var(--gold);font-weight:700">जन्म</span>' : ''}
        ${isMoon  ? '<span style="font-size:.7rem;position:absolute;top:4px;right:6px;color:#1a6a30;font-weight:700">आज</span>' : ''}
...
function _tmRenderMurti(d) {
  ...
  <div class="tm-info-strip">
    <div>
      <div class="tm-strip-title">${d.varaHi} · चन्द्र: ${d.moonNakHi} (चरण ${d.moonPada}) · राशि: ${d.moonRashiHi}</div>
      <div class="tm-strip-sub">मूर्ति = (वार + नक्षत्र) mod 4 — BPHS Ch.87</div>
    </div>
    <span class="tm-strip-badge">मूर्ति निर्णय</span>
  </div>`;
  ...
  html += `
  <div class="tm-section">
    <div class="tm-section-title">सामान्य मूर्ति (वार + चन्द्र नक्षत्र)</div>
    <div class="tm-murti-card" style="background:${gBg};border-color:${gColor}">
      ...
      <div class="tm-murti-upay">
        <span class="tm-upay-label">उपाय</span>
      ...
      <div class="tm-formula-box">
        <strong>गणना:</strong> ${d.murtiFormula?.general ?? ''}
      </div>
      <div class="tm-bphs-box">
        <div class="tm-bphs-title">॥ बृहत् पाराशर होरा शास्त्र — अध्याय 87 ॥</div>
        ${gm.bphs}
      </div>
    </div>
  </div>`;
  ...
  if (pm) {
    ...
    html += `
    <div class="tm-section">
      <div class="tm-section-title">व्यक्तिगत मूर्ति (वार + जन्म नक्षत्र + चन्द्र नक्षत्र)</div>
      <div class="tm-murti-card" style="background:${pBg};border-color:${pColor}">
        ...
        <div class="tm-formula-box">
          <strong>गणना:</strong> ${d.murtiFormula?.personal ?? ''}
        </div>
      </div>
    </div>`;
  }
  ...
  html += `
  <div class="tm-section">
    <div class="tm-section-title">चारों मूर्तियाँ — सम्पूर्ण विवरण</div>
  ...
  html += `
  <div class="tm-section">
    <div class="tm-section-title">सप्त वार — मूर्ति सारिणी</div>
    <table class="tm-vara-table">
      <thead><tr><th>वार</th><th>मूर्ति</th><th>फल</th></tr></thead>
      <tbody>`;
...
function _tmRenderNak(d) {
  ...
  const mtypeLabels = ['अति शुभ (लघु/क्षिप्र)','शुभ (मृदु)','मध्यम (चर)','अशुभ (उग्र)','अति अशुभ (तीक्ष्ण)'];
  const mtypeColors = ['#1a5a20','#2a6a30','#7a6010','#8a3010','#8a1010'];

  let html = `
  <div class="tm-info-strip">
    <div>
      <div class="tm-strip-title">चन्द्र नक्षत्र: ${nd.nakHi ?? ''} — ${nd.nakEn ?? ''}</div>
      <div class="tm-strip-sub">BPHS + मुहूर्त चिन्तामणि नक्षत्र गुण विवरण</div>
    </div>
  ...
  <div class="tm-section">
    <div class="tm-section-title">${nd.nakHi ?? ''} नक्षत्र — सम्पूर्ण विवरण</div>
    <div class="tm-nak-detail">
      <div class="tm-nak-item">
        <div class="tm-nak-item-label">नक्षत्र क्रमांक</div>
        <div class="tm-nak-item-val">${(nd.nak ?? 0) + 1}/27</div>
        <div class="tm-nak-item-sub">${nd.nakEn ?? ''}</div>
      </div>
      <div class="tm-nak-item">
        <div class="tm-nak-item-label">चरण</div>
        <div class="tm-nak-item-val">${nd.pada ?? ''}</div>
        <div class="tm-nak-item-sub">नवांश: ${nd.charanaRashi ?? ''}</div>
      </div>
      <div class="tm-nak-item">
        <div class="tm-nak-item-label">नक्षत्र स्वामी</div>
        <div class="tm-nak-item-val">${nd.lord ?? ''}</div>
      </div>
      <div class="tm-nak-item">
        <div class="tm-nak-item-label">गण</div>
        <div class="tm-nak-item-val">${nd.gana ?? ''}</div>
        <div class="tm-nak-item-sub">देव / मनुष्य / राक्षस</div>
      </div>
      <div class="tm-nak-item">
        <div class="tm-nak-item-label">नाड़ी</div>
        <div class="tm-nak-item-val">${nd.nadi ?? ''}</div>
        <div class="tm-nak-item-sub">आदि / मध्य / अन्त्य</div>
      </div>
      <div class="tm-nak-item">
        <div class="tm-nak-item-label">तत्त्व</div>
        <div class="tm-nak-item-val" style="color:${nd.tatvaColor ?? '#000'}">${nd.tatva ?? ''}</div>
      </div>
      <div class="tm-nak-item">
        <div class="tm-nak-item-label">गुण</div>
        <div class="tm-nak-item-val">${nd.guna ?? ''}</div>
        <div class="tm-nak-item-sub">सात्विक / राजस / तामस</div>
      </div>
      <div class="tm-nak-item">
        <div class="tm-nak-item-label">मुहूर्त वर्ग</div>
    ...
    <div class="tm-bphs-box" style="margin-top:16px">
      <div class="tm-bphs-title">नक्षत्र देवता एवं गुण</div>
      ${nd.desc ?? ''}
    </div>
  </div>

  <div class="tm-section">
    <div class="tm-section-title">सभी 27 नक्षत्र — मुहूर्त वर्गीकरण</div>
    <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(185px,1fr));gap:8px">`;

  const nakHiArr = ['अश्विनी','भरणी','कृत्तिका','रोहिणी','मृगशिरा','आर्द्रा','पुनर्वसु','पुष्य','आश्लेषा','मघा','पूर्वाफाल्गुनी','उत्तराफाल्गुनी','हस्त','चित्रा','स्वाति','विशाखा','अनुराधा','ज्येष्ठा','मूल','पूर्वाषाढ़ा','उत्तराषाढ़ा','श्रवण','धनिष्ठा','शतभिषा','पूर्वाभाद्रपदा','उत्तराभाद्रपदा','रेवती'];
...
function _tmRenderRef(d) {
  ...
  <div class="tm-info-strip">
    <div>
      <div class="tm-strip-title">शास्त्र सन्दर्भ — तारबल एवं मूर्ति निर्णय</div>
      <div class="tm-strip-sub">बृहत् पाराशर होरा शास्त्र · मुहूर्त चिन्तामणि · ज्योतिर्निबन्ध</div>
    </div>
    <span class="tm-strip-badge">BPHS Reference</span>
  </div>

  <div class="tm-section">
    <div class="tm-section-title">तारबल गणना विधि — BPHS Ch.26</div>
    <div style="font-family:'Tiro Devanagari Sanskrit',serif;font-size:1.1rem;line-height:2.1;color:var(--ink2)">
      <p style="margin-bottom:12px"><strong>सूत्र:</strong> जन्म नक्षत्र से वर्तमान चन्द्र नक्षत्र की गणना करें।
        यह दूरी तीन चक्रों में 9-9 की "तारा" देती है।</p>
      <p style="margin-bottom:12px"><strong>गणना:</strong> (चन्द्र नक्षत्र − जन्म नक्षत्र + 27) mod 27 = दूरी<br>
         दूरी mod 9 + 1 = तारा क्रमांक (1–9)</p>
      <p style="margin-bottom:12px"><strong>तीन आवर्त:</strong> पहला आवर्त (0-8) = पूर्ण फल · दूसरा (9-17) = 50% फल · तीसरा (18-26) = 25% फल</p>
      <p><strong>BPHS श्लोक (26.3):</strong></p>
      <div class="tm-bphs-box" style="font-style:italic;color:var(--golddk);font-size:1.05rem">
        "जन्मादि तारागणना विलोम्य, सम्पत्-विपत्-क्षेम-प्रत्यरि-साधक-नैधन-मित्र-अतिमित्र तारा फलं ज्ञेयम्।"
      </div>
    </div>
  ...
  <div class="tm-section">
    <div class="tm-section-title">मूर्ति निर्णय विधि — BPHS Ch.87</div>
    <div style="font-family:'Tiro Devanagari Sanskrit',serif;font-size:1.1rem;line-height:2.1;color:var(--ink2)">
      <p style="margin-bottom:12px"><strong>सूत्र (सामान्य):</strong> (वार क्रमांक + चन्द्र नक्षत्र) mod 4
        → 0=स्वर्ण · 1=रजत · 2=ताम्र · 3=लौह</p>
      <p style="margin-bottom:12px"><strong>सूत्र (व्यक्तिगत):</strong> (वार + जन्म नक्षत्र + चन्द्र नक्षत्र) mod 4</p>
      <p><strong>BPHS श्लोक (87.4):</strong></p>
      <div class="tm-bphs-box" style="font-style:italic;color:var(--golddk);font-size:1.05rem">
        "स्वर्ण-रजत-ताम्र-लौह मूर्तयः क्रमेण श्रेष्ठ-मध्यम-अधम-अशुभ फलदाः।"
      </div>
    </div>
    <div style="display:flex;flex-direction:column;gap:10px;margin-top:18px">
      ${[0,1,2,3].map(i => {
