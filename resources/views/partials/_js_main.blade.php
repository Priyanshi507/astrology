...
document.addEventListener('keydown',e=>{
  ...
  if(document.getElementById('resultCard').style.display==='none') return;
  const map={l:'lagna',t:'tithi',p:'masa',c:'chart',d:'dasha',b:'shadbala',f:'festival',h:'muhrat',g:'varga',s:'sun',m:'moon',e:'mercury',v:'venus',a:'mars',j:'jupiter',k:'saturn',r:'rahu',u:'ketu',y:'tarabal',i:'murti'};
