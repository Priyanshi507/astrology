...
<style>
/* ════════════════════════════════════════════════════════════
   FESTIVAL PANEL v10 — Vedic Panchanga PANCHANG AESTHETIC
...
<div id="festivalPanel" style="display:none">
  ...
  <div class="fp-hero">
    <div class="fp-hero-inner">
      <div class="fp-eyebrow">Vedic Panchanga · Lahiri Ayanamsa</div>
      <div class="fp-title-row">
        <div class="fp-title-hi">Panchanga Calendar</div>
        <span class="fp-samvat">Vikram Samvat 2082</span>
      </div>
      <div class="fp-title-sub">Hindu Festival, Vrat &amp; Observance Calendar</div>
      <div class="fp-meta-row">
        <span class="fp-meta-tag">All Vrats</span>
        <span class="fp-meta-tag">Festivals</span>
        <span class="fp-meta-tag">Jayanti</span>
        <span class="fp-meta-tag">Sankranti</span>
        <span class="fp-meta-tag">Purnima</span>
        <span class="fp-meta-tag">Ekadashi</span>
  ...
  <div class="fp-year-bar">
    ...
    <button class="fp-yr-btn" onclick="festNav(1)">›</button>
    <span class="fp-yr-label" id="festYearLabel">2026</span>
  ...
  <div id="festivalContent">
    <div class="fp-loading">
      ...
      <div class="fp-loading-text">
        Select a year and<br>
        click <strong style="color:var(--fp-saffron)">Load Year</strong>
      </div>
    </div>
  </div>
